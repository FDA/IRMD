...
<div class="main-container"> 
  ...
  <div id="errorContentDiv" class="alert alert-danger text-center fade in hide"></div></br> 
    ...
    <div class="white-wrapper">
      <h1>Add Lab ProtoType</h1>
	  <form:form method="POST" id="protoForm" action="save" modelAttribute="labPrototype" enctype="multipart/form-data" onsubmit="return validate('protoForm');">
      <div class="row">
